					...
					<form name="store_info" method="post" enctype="multipart/form-data">
						<div class="row card" style="min-height:10px; margin-bottom:10px;">
							<div class="body" align="center" style="padding:10px;" >
								<input class="btn btn-warning" name="dunit_ad"  type="submit" id="dunit_ad" value="Add" />
								<input class="btn btn-warning" name="dunit_updt" type="submit" id="dunit_updt" value="Update" />
								<input class="btn btn-warning" name="dunit_dlt" type="submit" id="dunit_dlt" value="Delete" onclick="return confirm('Are you sure you want to delete?');" />
								<input class="btn btn-warning" name="dunit_clr" type="button" id="dunit_clr" onclick="parent.location='index.php?pg=<?php echo $_GET[pg]; ?>'" value="Clear" />
							</div>
						</div>
						<div class="row card">
							<div class="header">
				...
				<div class="col-md-6">
					<div class="card">
						<div class="body table-responsive">
							<table class="table table-striped table-hover dataTable" data="unit_info">
								<thead>
									<tr>
