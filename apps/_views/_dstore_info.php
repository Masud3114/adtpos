					...
					<form name="store_info" method="post" enctype="multipart/form-data">
						<div class="row card" style="min-height:10px; margin-bottom:10px;">
							<div class="body" align="center" style="padding:10px;" >
								<input class="btn btn-warning" name="dstore_ad"  type="submit" id="dstore_ad" value="Add" />
								<input class="btn btn-warning" name="dstore_updt" type="submit" id="dstore_updt" value="Update" />
								<input class="btn btn-warning" name="dstore_dlt" type="submit" id="dstore_dlt" value="Delete" onclick="return confirm('Are you sure you want to delete?');" />
								<input class="btn btn-warning" name="dstore_clr" type="button" id="dstore_clr" onclick="parent.location='index.php?pg=<?php echo $_GET[pg]; ?>'" value="Clear" />
							</div>
						</div>
						<div class="row card">
							<div class="header">
								<center><h3>Store Details</h3></center>
							</div>
							<div class="body">
				...
				<div class="col-md-6">
					<div class="card">
						<div class="body table-responsive">
							<table class="table table-striped table-hover dataTable" data="store_info">
								<thead>
									<tr>
