					...
					if(isset($_GET['sx_code'])){
						...
						WHERE t1.trn_cat=2 AND t1.slno='".@mysql_real_escape_string($_GET['sx_code'])."'";
						$header_data=$cmncls->newpikval(null,null,null,$sx_sql);
						$_SESSION['recv_slno']=$header_data['slno'];
					}
					?>
					...
					<div class="row">
						<div class="col-md-12">
							<form name="dcompny_info" method="post" enctype="multipart/form-data">
								<div class="row card">
									<div class="header">
										<center><h3>Product Receive Entry</h3></center>
									</div>
									<div class="body">
										<div class="col-md-4">
											<div class="form-group form-float">
												<div class="input-group">
													...
													<select style="width:100%;" class="form-control select2auto" ppg="s2search" name="dsup_cod">
														<?php
														if(isset($header_data['trn_from'])){
															...
															echo '<option value="SUP-00000001" selected="selected">Opening Balance</option>';
														}
														?>
													</select>
												</div>
											...
											<div class="form-group form-float">
												...
												<a href="?pg=receiv_list" title="Back" class="btn bg-blue waves-effect">
