						...
						<div class="row card">
							...
							<div class="body">
								...
								<div class="form-group form-float">
									...
									<div class="form-line">
										<textarea type="text" class="form-control" id="info_details" name="info_details"><?php echo $pickval[info_details]; ?></textarea>
										<input type="hidden" name="info_location" value="our_values" />
							...
							<table class="table table-striped table-hover">
								...
								<tbody>
									...
									$sql_qry = "SELECT concat((LEFT(info_title , 40)),'...') as info_title, slno
										FROM company_info
										where info_location='our_values' AND sts = '1' ".$whr_cmd."";
