									...
									<form name="dcompny_info" method="post" enctype="multipart/form-data">
										<div class="row card" style="min-height:10px; margin-bottom:10px;">
											<div class="body" align="center" style="padding:10px;" >
												...
												<input class="btn btn-warning" name="dcus_clr" type="button" id="dcus_clr" onclick="parent.location='index.php?pg=<?php echo $_GET['pg']; ?>'" value="Clear" />
											</div>
										</div>
										<div class="row card">
											<div class="header">
												<center><h3>Food Customer Information</h3></center>
											</div>
											<div class="body">
												...
												<div class="form-group form-float">
													<div class="form-line">
														<input type="text" class="form-control" id="attnd_id" name="attnd_id" value="<? echo $pickval[attnd_id]; ?>" />
												...
												<div class="form-group form-float" align="left">
													<div class="form-line">
														<select name="dcus_type" class="form-control show-tick" required>
															<option value="">Select Customer Type</option>
															<option value="1"<?php echo $pickval[dcus_type]=='1'? 'selected':''; ?>>Regular</option>
															<option value="2"<?php echo $pickval[dcus_type]=='2'? 'selected':''; ?>>Irregular</option>
														</select>
													</div>
												</div>
												<div class="form-group form-float" align="left">
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<div class="card">
										<div class="body table-responsive">
											<table class="table table-striped table-hover dataTable" data="food_cus">
												<thead>
													<tr>
