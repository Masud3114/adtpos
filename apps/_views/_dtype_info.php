					...
					<form name="store_info" method="post" enctype="multipart/form-data">
						<div class="row card" style="min-height:10px; margin-bottom:10px;">
							<div class="body" align="center" style="padding:10px;" >
								<input class="btn btn-warning" name="dtype_ad"  type="submit" id="dtype_ad" value="Add" />
								<input class="btn btn-warning" name="dtype_updt" type="submit" id="dtype_updt" value="Update" />
								<input class="btn btn-warning" name="dtype_dlt" type="submit" id="dtype_dlt" value="Delete" onclick="return confirm('Are you sure you want to delete?');" />
								<input class="btn btn-warning" name="dtype_clr" type="button" id="dtype_clr" onclick="parent.location='index.php?pg=<?php echo $_GET[pg]; ?>'" value="Clear" />
							</div>
						</div>
						<div class="row card">
							<div class="header">
								<center><h3>Type Details</h3></center>
							</div>
							<div class="body">
								...
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control" required="required"  id="pramalt_code" name="pramalt_code" value="<?php echo $pickval[pramalt_code]; ?>" />
										<label class="form-label">ALT Code</label>
									</div>
								</div>
								<?php
				...
				<div class="col-md-6">
					<div class="card">
						<div class="body table-responsive">
							<table class="table table-striped table-hover dataTable" data="type_info">
								<thead>
									<tr>
