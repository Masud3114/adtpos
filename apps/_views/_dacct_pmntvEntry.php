									...
									<ul class="nav nav-tabs" role="tablist" id="myTab">
										...
										<li role="presentation">
											<a class="waves-effect" href="#acct_gldetails" data-toggle="tab">
												<i class="material-icons">exposure</i> Voucher Details
											</a>
										</li>
										<?php
									...
									<div class="tab-content row" id="myTabContent">
											...
											<div class="col-md-8">
												<div class="card">
													<div class="body table-responsive">
														<table class="table table-striped table-hover dataTable" data="acct_paymentgl">
															<thead>
																<tr>
										...
										<div role="tabpanel" class="tab-pane fade in" id="acct_gldetails">
											...
											<div class="col-md-8">
												<div class="card">
													<div class="body table-responsive">
														<table class="table table-striped table-hover dataTableSub" style="width:100%;" prams="<?php echo $pickval['slno']; ?>" data="acct_pmntgldetails">
															<thead>
																<tr>
