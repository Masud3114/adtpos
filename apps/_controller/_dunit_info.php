...
&& strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
	...
	if(isset($_POST[dunit_ad])){
		$_POST['slno'] = $action->getslno('item_pram');
		$_POST['pram_type'] = 'unit';
		$skip_valus=array('dunit_ad','ppg');
	...
	else if (isset($_POST['dunit_updt'])){
		if($_POST['slno']!=NULL){
			$skip_valus=array('dunit_updt','slno','ppg');
