...
&& strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
	...
	if(isset($_POST[dstore_ad])){
		$_POST['slno'] = $action->getslno('item_pram');
		$_POST['pram_type'] = 'store';
		$skip_valus=array('dstore_ad','ppg');
	...
	else if (isset($_POST['dstore_updt'])){
		if($_POST['slno']!=NULL){
			$skip_valus=array('dstore_updt','slno','ppg');
		...
		$_SESSION['msg'] = $msg;
		$_SESSION['clor'] = $clor;
	}else if(isset($_POST['dstore_dlt'])){
