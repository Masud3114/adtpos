...
&& strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
	...
	if(isset($_POST[dcolor_ad])){
		$_POST['slno'] = $action->getslno('item_pram');
		$_POST['pram_type'] = 'color';
		$skip_valus=array('dcolor_ad','ppg');
	...
	else if (isset($_POST['dcolor_updt'])){
		if($_POST['slno']!=NULL){
			$skip_valus=array('dcolor_updt','slno','ppg');
		...
		$_SESSION['msg'] = $msg;
		$_SESSION['clor'] = $clor;
	}else if(isset($_POST['dcolor_dlt'])){
