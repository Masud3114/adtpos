...
&& strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
	...
	if(isset($_POST[dsize_ad])){
		$_POST['slno'] = $action->getslno('item_pram');
		$_POST['pram_type'] = 'size';
		$skip_valus=array('dsize_ad','ppg');
	...
	else if (isset($_POST['dsize_updt'])){
		if($_POST['slno']!=NULL){
			$skip_valus=array('dsize_updt','slno','ppg');
